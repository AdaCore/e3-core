...
if TYPE_CHECKING:
    ...
    from typing import IO, Any, Final, Literal, TextIO

    from e3.os.process import DEVNULL_VALUE, PIPE_VALUE, Run

    Git_Cmd = list[str] | list[str | None]
...
class GitRepository:
    ...
    def init(self, url: str | None = None, remote: str | None = "origin") -> None:
        ...
        e3.fs.mkdir(Path(self.working_tree, ".git", "logs", "refs"))

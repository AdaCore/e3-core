...
if __name__ == '__main__':
    ...
    parser.add_argument('coverage_rc_filename',
                        help='The name of the coverage configuration file.')
    parser.add_argument(
        '--omit-from-file', dest='omit_list_filename',
        help=('The name of the file providing a list of files which should'
    ...
    main(args.coverage_rc_filename,
         omit_list_filename=args.omit_list_filename)
